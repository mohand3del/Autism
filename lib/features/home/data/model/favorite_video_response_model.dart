...
part 'favorite_video_response_model.g.dart';
@JsonSerializable()
class FavoriteVideoResponseModel {
  ...
  factory FavoriteVideoResponseModel.fromJson(Map<String, dynamic> json) =>
      _$FavoriteVideoResponseModelFromJson(json);

  Map<String, dynamic> toJson() => _$FavoriteVideoResponseModelToJson(this);
}
