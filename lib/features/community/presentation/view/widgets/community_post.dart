...
class _CommunityPostState extends State<CommunityPost> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Column(
        children: [
          const Divider(thickness: 4,color: AppColors.dotGray,),
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                GestureDetector(
                  onLongPress: _onLongPressLike, // Show reactions on long press
                  child: PostActionButton(
                    icon: const AssetImage('assets/images/outlined_like.png'),
                    text: 'Like',
                    onTap: () {
                      // Handle Like
                    },
